...
/**
 * Conservative security suite:
 * - does NOT change cookie flags required for production login
 * - focuses on rejecting missing/tampered sessions and invalidated sessions
 */
