  ...
  describe('Comprehensive Guest Restrictions', () => {
    it('should verify all modification endpoints are blocked for guests', async () => {
      const modificationEndpoints = [
        ...
        { method: 'POST', path: `/api/v1/decks/${testDeckId}/cards`, data: { cardType: 'character', cardId: testCharacterId } },
        { method: 'DELETE', path: `/api/v1/decks/${testDeckId}/cards`, data: { cardType: 'character', cardId: testCharacterId } },
    ...
    it('should verify all read endpoints are allowed for guests', async () => {
      const readEndpoints = [
        ...
        { method: 'GET', path: `/api/v1/decks/${testDeckId}/cards` }
      ];
