-- Final teamwork card corrections to match the exact correct table
-- This migration ensures all existing teamwork cards have the correct image paths

-- Update all teamwork card image paths to match the exact correct table data

-- 6 Any-Power (should be correct already)
UPDATE teamwork_cards 
SET image_path = 'teamwork-universe/6_anypower.webp'
WHERE name = '6 Any-Power' 
AND universe = 'ERB';

-- 6 Brute Force cards - ensure correct image paths
UPDATE teamwork_cards 
...
-- 6 Combat cards - ensure correct image paths
UPDATE teamwork_cards 
...
-- 6 Energy cards - ensure correct image paths
UPDATE teamwork_cards 
...
-- 6 Intelligence cards - ensure correct image paths
UPDATE teamwork_cards 
...
-- 7 Any-Power (should be correct already)
UPDATE teamwork_cards 
SET image_path = 'teamwork-universe/7_anypower.webp'
WHERE name = '7 Any-Power' 
AND universe = 'ERB';

-- 7 Brute Force cards - ensure correct image paths
UPDATE teamwork_cards 
...
-- 7 Combat cards - ensure correct image paths
UPDATE teamwork_cards 
...
-- 7 Energy cards - ensure correct image paths
UPDATE teamwork_cards 
...
-- 7 Intelligence cards - ensure correct image paths
UPDATE teamwork_cards 
...
-- 8 Brute Force cards - ensure correct image paths
UPDATE teamwork_cards 
...
-- 8 Combat cards - ensure correct image paths
UPDATE teamwork_cards 
...
-- 8 Energy cards - ensure correct image paths
UPDATE teamwork_cards 
...
-- 8 Intelligence cards - ensure correct image paths
UPDATE teamwork_cards 
