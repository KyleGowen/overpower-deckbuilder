...
**Sample** (legacy envelope; character, location, and special-card **lists** are v1-only — see [API_V1.md](API_V1.md)):
...
| GET | `/missions`, `/events`, `/aspects`, `/advanced-universe`, `/teamwork`, `/ally-universe`, `/training`, `/basic-universe`, `/power-cards`, `/foil-card-map`, `/deck-backgrounds`, `/test` | `card-api.routes.ts` |
...
| GET | `/api/v1/catalog/characters`, `/api/v1/catalog/locations`, `/api/v1/catalog/special-cards` | `src/api/http/dbv-catalog.http.ts` |
