...
**Sample** (legacy envelope; character, location, special-card, mission, event, aspect, and advanced-universe **lists** are v1-only — see [API_V1.md](API_V1.md)).
