...
| [src/api/.cursorrules](../../../src/api/.cursorrules) | API-area rules while Cursor context files remain in the repo |
...
- [ ] **Codex local proof** with browser automation, screenshot, `curl`, or equivalent: prove the route (or the UI flow that calls it) works end-to-end—see skill loop **step 11**

## Changelog (skill + layer)

| Date | Note |
|------|------|
| 2026-04-03 | Initial skill: doc + context updates required per migration. |
...
| 2026-07-21 | Codex migration: route proof uses local browser/API verification instead of Cursor IDE browser tooling. |
