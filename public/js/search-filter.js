...
function clearAllFiltersGlobally() {
    ...
    const missionsMobileCardNameFilter = document.getElementById('missions-mobile-card-name-filter');
    if (missionsMobileCardNameFilter) missionsMobileCardNameFilter.value = '';
