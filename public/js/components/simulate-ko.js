...
(function() {
    ...
    function buildKoDimmingContext(deckCards, availableCardsMap) {
        const activeCharacters = getActiveCharacters(deckCards, availableCardsMap);
    ...
    function applyDimming(deckCards, availableCardsMap) {
        ...
        const ctx = buildKoDimmingContext(deckCards, availableCardsMap);
        ...
        deckCardElements.forEach(cardElement => {
            ...
            const shouldDim = shouldDimNonCharacterByType(cardType, cardId, cardData, ctx, true);
    ...
    function shouldDimCard(card, availableCardsMap, deckCards) {
        ...
        const ctx = buildKoDimmingContext(deckCards, availableCardsMap);
        return shouldDimNonCharacterByType(cardType, cardId, cardData, ctx, false);
    }
