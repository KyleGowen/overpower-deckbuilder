...
The deck import flow parses v2.0 export JSON, resolves card names via catalog, and creates a new deck via HTTP APIs. This document describes the JSON contract and resolution rules.

## Dependencies (v2)

### React / API
- [`importDeckFromJson.ts`](../../frontend/src/lib/decks/importDeckFromJson.ts) — core import logic
- [`ImportDeckPanel.tsx`](../../frontend/src/features/deck-selection/ImportDeckPanel.tsx) — UI
- Catalog queries via TanStack Query + `/api/v1/catalog/*`
...
Import panel styles live in [`ImportDeckPanel.css`](../../frontend/src/features/deck-selection/ImportDeckPanel.css) and shared v2 tokens in [`STYLE_GUIDE_V2.md`](../../STYLE_GUIDE_V2.md).
...
**Main test file**: `tests/unit/frontend-v2/importDeckFromJson.test.ts`
...
- [`buildDeckExportJson.ts`](../../frontend/src/lib/decks/buildDeckExportJson.ts) — export counterpart
- [`docs/current/DECK_EXPORT.md`](DECK_EXPORT.md) — export contract
- `tests/unit/frontend-v2/importDeckFromJson.test.ts` — unit tests
